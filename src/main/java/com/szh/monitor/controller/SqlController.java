...
public class SqlController {
    ...
    @OperationLog(module = "SQL数据源", operationType = "CREATE", description = "创建SQL数据源")
    ...
    @OperationLog(module = "SQL数据源", operationType = "EDIT", description = "修改SQL数据源")
    ...
    @OperationLog(module = "SQL数据源", operationType = "DELETE", description = "删除SQL数据源")
    ...
    @PostMapping("/refresh")
    @OperationLog(module = "SQL配置", operationType = "EDIT", description = "刷新SQL配置")
